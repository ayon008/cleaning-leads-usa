...
const Contact = () => {
  return (
    <section
      id="contact"
      className="bg-[url('/slider-02-b.jpg')] bg-cover bg-no-repeat bg-center h-dvh max-h-[734px] w-full relative mt-20"
    >
      <div className="container h-full flex items-center justify-between gap-10">
        <div className="">
