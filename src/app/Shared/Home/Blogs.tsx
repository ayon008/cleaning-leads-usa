...
const Blogs = async ({ page }: { page: number }) => {
  ...
  return (
    <section id="blogs" className="mb-10" role="region" aria-labelledby="blogs-headline" aria-describedby="blogs-sub" itemScope itemType="http://schema.org/Blog">
      <div className="container">
        <Title
          ...
          headlineId="blogs-headline"
          subHeadingId="blogs-sub"
        />
        <div>
